...
declare global {
  ...
  var bchAnimationEngineEnabled: () => boolean;
  var bch_initializeDefaultExpression: () => void;
  var bchUpdatePasswordForReconnect: () => void;
  var bchMessageReplacements: (msg: string) => string;
  var bch_EventExpressions: { [key: string]: Expression };
  var bchClearPassword: (name: string) => void;
  var bchClearCaches: () => Promise<void>;
  var bchDisplayText: (
    original: string,
    replacements?: Record<string, string>
  ) => string;
  var bch_ArousalExpressionStages: ArousalExpressionStages;
  var bch_ActivityTriggers: ActivityTrigger[];
  ...
  var bchGotoRoom: (room: string) => void;
  ...
  var bchStartClubSlave: () => Promise<void>;
  var bchSendToClubSlavery: () => void;
  var bchCanSendToClubSlavery: () => boolean;
  var ChatRoombchSendToClubSlavery: () => void;
  var ChatRoombchCanSendToClubSlavery: () => boolean;
...
declare global {
  ...
  type Character = {
    ...
    BCH: string;
    BCHArousal: boolean;
    BCHCapabilities: string[];
    BCHArousalProgress: number;
    BCHEnjoyment: number;
  ...
  type BCHCharacterState = { clamped: number };
